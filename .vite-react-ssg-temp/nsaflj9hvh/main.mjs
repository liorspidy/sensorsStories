...
var Header_module_default = {
	header: "_header_1si16_2",
	slideDown: "_slideDown_1si16_1",
	hidden: "_hidden_1si16_23",
	slideUp: "_slideUp_1si16_1",
	scrolled: "_scrolled_1si16_27",
	sticky: "_sticky_1si16_47",
	headerLogo: "_headerLogo_1si16_52",
	logo: "_logo_1si16_64",
	header_nav: "_header_nav_1si16_70",
	header_link: "_header_link_1si16_81",
	hamburgerWrapper: "_hamburgerWrapper_1si16_103",
	header_logo: "_header_logo_1si16_147"
};
//#endregion
...
var Header = () => {
	...
	return /* @__PURE__ */ jsxs(Fragment, { children: [/* @__PURE__ */ jsxs("nav", {
		...
		children: [
			...
			/* @__PURE__ */ jsxs("nav", {
				className: Header_module_default.header_nav,
				children: [
					/* @__PURE__ */ jsx(Link, {
						className: Header_module_default.header_link,
						to: "/",
						onClick: () => {
							navigate("/");
...
var Main = lazy(() => import("./assets/Main-73vlztet.js"));
var About = lazy(() => import("./assets/About-Bph0nKmX.js"));
