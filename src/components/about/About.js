      ...
      <motion.div className={aboutBoxClass} variants={aboutBoxClassVarients}>
        ...
        <div className={aboutDescClass}>
          <p>
            ...
            הכישלון גדלה והתעצמה בבית הספר, בבית ובמפגשים משפחתיים.
          </p>

          <p>
            הקושי היה בכתיבה ובתקשורת. היה לי קשה להסביר את עצמי, דיברתי באופן
            אסוציאטיבי והיה קשה להבין אותי. המודעות שלי לקושי הייתה גבוהה מאוד.
            רגשות של תסכול, עצב , אכזבה מעצמי, היו יום יומיים. אני זוכרת שלחברה
            שלי קנו את הכרכים הראשונים של האנציקלופדיה העברית וכל כך רציתי לקרוא
            הכל ולדעת הכל.
          </p>
          ...
          <p>
            אני מגלה שאני מסוגלת ללמוד בדרך שלי ומצליחה ללמוד את מה שאני אוהבת.
            היום אנחנו מכירים את המושג אוטודידקטית. כשנולדה בתי הראשונה מעיין,
            נתקלתי בקושי חדש מעיין לא מפסיקה לבכות והרי יש לי כבר לא מעט ידע וזה
            לא עוזר, שוב חווית התסכול חוזרת ופוגשת את התסכול של מעיין, את העצב
            ואת הקושי להסביר. כל פעילות שהיינו צריכות לעשות הייתה מלווה בבכי
          ...
          <p>
            ...
            החושים בעולמנו פיזיולוגית, פיזית, מנטלית, רגשית ורוחנית.
          </p>

          <p>
            אני מלווה את מעיין בכל צעד וצעד, האתגרים היו לא מעטים. התמודדנו עם
            כל אתגר לאט לאט בהקשבה עמוקה, בסבלנות, בהבנה ובבניית תוכניות.
            ציירתי, כתבתי מילים, מספרים, יצרתי תוכניות עבודה ויזואליות למדנו
            לדבר להבין מה מעיין רוצה, תקשורת פנימית שלמדנו לבטא בתקשורת חיצונית.
            גאה לספר כי מעיין שלנו מסיימת תיכון בהצלחה, צבא ולומדת לתואר ראשון.
            מעיין לא מוותרת גם כשקשה, חוזרת על כל מבחן פעמיים, מצליחה לסיים את
            התואר וממשיכה ללמוד NLP.
          </p>
