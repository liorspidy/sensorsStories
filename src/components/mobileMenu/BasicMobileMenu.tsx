...
import classes from "./BasicMenu.module.scss";

interface BasicMobileMenuProps {
  setVisible: (v: boolean) => void;
}

export default function BasicMobileMenu({ setVisible }: BasicMobileMenuProps): React.ReactElement {
  ...
  const handleMenuItemClick = (path: string, elementId: string): void => {
    navigate(path);
    setTimeout(() => {
